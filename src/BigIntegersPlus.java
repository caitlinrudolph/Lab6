...
public class BigIntegersPlus
{
    ...
    public static void main(String[] args) {
        ...
        runFullExperiment("BigIntegersPlus-Exp1-ThrowAway.txt");
        System.out.println("Running second full experiment...");
        runFullExperiment("BigIntegersPlus-Exp2.txt");
        System.out.println("Running third full experiment...");
        runFullExperiment("BigIntegersPlus-Exp3.txt");
    ...
    static void runFullExperiment(String resultsFileName)
    {
        ...
        {
            // To add
            MyBigIntegers currAdd = new MyBigIntegers();
