...
public class BigIntegersTimes {
    ...
    public static void main(String[] args) {
        ...
        runFullExperiment("BigIntegersTimes-Exp1-ThrowAway.txt");
        System.out.println("Running second full experiment...");
        runFullExperiment("BigIntegersTimes-Exp2.txt");
        System.out.println("Running third full experiment...");
        runFullExperiment("BigIntegersTimes-Exp3.txt");
    ...
    static void runFullExperiment(String resultsFileName)
    {
        ...
        {
            // To add
            MyBigIntegers currTimes = new MyBigIntegers();
            ...
            for (long trial = 0; trial < numberOfTrials; trial++)
            {
                ...
                currTimes = currTimes.Times(currTimes);
            }
